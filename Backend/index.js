...
const uri = `mongodb+srv://${process.env.UNAME}:${process.env.PASSWORD}.obuza08.mongodb.net/?retryWrites=true&w=majority`;
...
app.listen(port, () => {
    console.log(`Twitter clone is listening on port http://localhost:${port}`)
})